...
bool CMainScene::Init()
{
	...
	CreateParticle();
	CResourceManager::GetInst()->SoundStop("fightbgm");
	...
	pAlRamWidget->OtherTexture("안전구축", TEXT("안전구축.png"));
	
	CSelectCard* pSelect = m_pScene->SpawnObject<CSelectCard>("SelectCard");
	CDeck* pDeck = nullptr;
	CDeck* pDeck2 = nullptr;
	switch (CClientManager::GetInst()->Getfirst())
	{
	case 1:
		pDeck = m_pScene->SpawnObject<CMagicDeck>("CMagicDeck");
		break;
	case 3:
		pDeck = m_pScene->SpawnObject<CWariorDeck>("CWariorDeck");
		break;
	case 8:
		pDeck = m_pScene->SpawnObject<CtokoyoDeck>("CtokoyoDeck");
		break;
	default:
		break;
	}
	...
	{
	case 1:
		pDeck2 = m_pScene->SpawnObject<CMagicDeck>("CMagicDeck");
		break;
	case 3:
		pDeck2 = m_pScene->SpawnObject<CWariorDeck>("CWariorDeck");
		break;
	case 8:
		pDeck2 = m_pScene->SpawnObject<CtokoyoDeck>("CtokoyoDeck");
		break;
	default:
		break;
	}
	...
	pSelect->GetSelectWidget()->SetDeck2(pDeck2);
	pSelect->GetSelectWidget()->SetDeck(pDeck);
	pDeck->SetSelectWidget(pSelect->GetSelectWidget());
	pDeck2->SetSelectWidget(pSelect->GetSelectWidget());
