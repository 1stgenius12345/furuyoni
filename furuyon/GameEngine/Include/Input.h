...
private:
    ...
    Vector2             m_MouseMove;
    bool                m_MousePush;
    float               m_MousePushTime;
    bool                m_MousePut;
    bool                m_MouseClick;
    bool                m_MouseRightPut;
    bool                m_MouseRightPush;
    float                m_MouseRightPushTime;

public: 
    bool GetMouseRightPut() const
    {
         return m_MouseRightPut;
    }
    bool GetMouseClick() const
    {
        return m_MouseClick;
    }
    bool GetMousePut() const
    {
        return m_MousePut;
    }
