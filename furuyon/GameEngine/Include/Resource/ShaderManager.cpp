...
{   
    if (!CreateShader<CStandard2DRange>("Standard2DRangeShader"))
        return false;
    if (!CreateShader<CUILogShader>("UILogShader"))
        return false;
    if (!CreateShader<CStandard2DLog>("Standard2DLogShader"))
        return false;
    if (!CreateShader<CStandard2DtitleShader>("Standard2DtitleShader"))
        return false;

    if (!CreateShader<CStandard2DCard>("Standard2DCard"))
        return false;
