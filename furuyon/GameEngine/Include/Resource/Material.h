...
public:
	float GetEmpty() const;
	void AddEmpty(float f);
	void SetEmpty(float f);
...
public:
	void AddBaseColor(float r, float g, float b, float a);
...
public:
	void AddEmissiveColor(const Vector4& Color);
