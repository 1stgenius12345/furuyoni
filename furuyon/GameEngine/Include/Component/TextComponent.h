...
protected:
    CTextComponent();
    CTextComponent(const CTextComponent& com);
...
private:
    ...
    TEXT_ALIGN_H2    m_AlignH;
    TEXT_ALIGN_V2    m_AlignV;
...
public:
    ...
    void SetAlignH(TEXT_ALIGN_H2 Align);
    void SetAlignV(TEXT_ALIGN_V2 Align);
